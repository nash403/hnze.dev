...
<template>
  ...
  <header class="sticky top-0 z-40 w-full select-none bg-background/40 backdrop-blur-[1.25rem] backdrop-saturate-[180%] has-[:checked]:bg-background">
    ...
    >
      ...
      <nav
        class="invisible absolute inset-x-0 top-full z-50 ml-auto border-b border-b-gray-300/40 bg-background pl-8 pr-4 opacity-0 duration-300 ease-linear peer-has-[:checked]:visible peer-has-[:checked]:opacity-100 sm:px-8 md:visible md:relative md:border-b-0 md:bg-transparent md:px-0 md:opacity-100"
      >
